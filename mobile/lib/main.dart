...
import 'ecrans/disponibilite/ecran_conseil_disponibilite.dart';
...
import 'ecrans/diagnostic/ecran_bienvenue.dart';
import 'ecrans/diagnostic/ecran_diagnostic.dart';
    ...
    return MultiProvider(
      ...
      child: MaterialApp(
        ...
        routes: {
          ...
          // ── Onboarding (objectifs → disponibilités → emploi du temps → diagnostic)
          Routes.objectifs:            (_) => const EcranObjectifs(),
          Routes.disponibilite:        (_) => const EcranDisponibilite(),
          Routes.conseilDisponibilite: (_) => const EcranConseilDisponibilite(),
          Routes.emploiDuTemps:        (_) => const EcranEmploiDuTemps(),
          Routes.bienvenue:            (_) => const EcranBienvenue(),
          Routes.diagnostic:           (_) => const EcranDiagnostic(),
